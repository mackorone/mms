...
private:
    unsigned char m_x; // x-location of the Cell
    unsigned char m_y; // y-location of the Cell
    unsigned char m_distance; // Distance of the Cell from the goal
    ...
    unsigned char m_wall_and_inspected; // Byte containing the wall and inspected values. Front right to left, we have NESW walls, and then NESW wallInspected

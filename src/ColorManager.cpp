...
const QString ColorManager::KEY_TILE_BASE_COLOR =
    "mouse-base-color";
const QString ColorManager::KEY_TILE_WALL_COLOR =
    "mouse-wall-color";
const QString ColorManager::KEY_TILE_CORNER_COLOR =
    "mouse-corner-color";
const QString ColorManager::KEY_MOUSE_BODY_COLOR =
    "mouse-body-color";
const QString ColorManager::KEY_MOUSE_WHEEL_COLOR =
    "mouse-wheel-color";
...
Color ColorManager::getTileWallIsSetColor() {
    return m_tileWallIsSetColor;
}
...
void ColorManager::update(
        Color tileBaseColor,
        Color tileWallColor,
        Color mouseBodyColor,
        Color mouseWheelColor,
    ...
    setValue(
        KEY_TILE_WALL_NOT_SET_ALPHA,
        QString::number(tileWallNotSetAlpha));
}

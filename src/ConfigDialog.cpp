...
QString ConfigDialog::getDirectory() {
    return m_directory->text();
}

QString ConfigDialog::getBuildCommand() {
    return m_buildCommand->text();
}

QString ConfigDialog::getRunCommand() {
